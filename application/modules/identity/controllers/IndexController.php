...
class Identity_IndexController extends Zend_Controller_Action
{
	public function preDispatch()
	{
		...
		//$saveHandler = Kutu_Application::getResource('session');
		//Zend_Session::setSaveHandler($saveHandler);
		
		
		//NO NEED CODES ABOVE. SESSION ENVIRONMENT IS CONFIGURED IN APPLICATION SESSION RESOURCE	
