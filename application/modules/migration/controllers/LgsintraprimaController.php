...
class Migration_LgsintraprimaController extends Kutu_Controller_Action
{
	...
	public function migrateLgsLegacyAction()
	{
		...
		//Important Addresses
		//$this->_migrateColumn(8, 'lgs4a1d7a32b3755');
		
		//Important Public Document
		//Belum semua catalognya dapat dimigrasi
		//5 catalog somehow tidak termigrasi, yaitu catalog yang diinput setelah catalog yang dijudulnya ada 1 juni 2009
		//$this->_migrateColumn(18, 'lgs4a1d7b8f71285');
		
		//who's who
		//$this->_migrateColumn(9, 'lgs4a1d7a02e32c1');
		
		//LGS Newsletters
		//$this->_migrateColumn(16, 'lgs4a1d783104616');
	...
	public function migrateLegalDatabaseAction()
	{
		...
		$this->_moveCategories(535,'sys_tmp');
		...
		//Boiler Plate
		//$this->_moveCategories(616,'sys_tmp');
