...
$jcart['path'] = JCART_PATH_URL; //'http://localhost/kutump-enhanced/lib/jcart/';
...
$jcart['form_action']	= JCART_FORMACTION_URL; //'http://localhost/kutump-enhanced/site/store/checkout';
//echo JCART_PATH_URL;
